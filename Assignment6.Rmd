...
**Your Answer:**
To test whether the variance of revenue (in millions of dollars) differs between movies with a female director and movies with a male director, I created the following test. I ran a chi-square test voor single variance, treating the male variance as known and fixed value with no sampling uncertainty. I also did a null hypothesis: the variance of revenue for female-directed movies equals the variance of male-directed movies. The alternative hypothesis we did means that the variances are nog equal with a significance level of 0.5.
